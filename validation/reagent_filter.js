...
export default d => {
  let errors = {};
  let data = {...d, containers: d.containers !== undefined ? { ...d.containers } : undefined };
  if(data.containers !== undefined && data.containers.registration_event !== undefined) {
    if(data.containers.registration_event.date !== undefined)
      data['containers.registration_event'] = data.containers.registration_event;
  }

  let input = {
    containers: ['mass', 'volume', 'concentration'],
    'containers.registration_event' : ['date'],
